...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">Bike List Information</h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
	  ...
	  <div class="printPageButton">  
			...
			<a href="#" class="btn-danger btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" data-toggle="modal" data-target="#addBike"> 
				<i class="fas fa fa-coin fa-m text-white-100" style="font-size:15px;" title="Mail"></i> Add New Bike	</a> 
			<a href="category.php" class="btn-danger btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;"> 
			<i class="fas fa fa-coin fa-m text-white-100" style="font-size:15px;" title="Mail"></i>Go to Pricing	</a> 
	   </div>
	   
					
            <div class="card shadow mb-4"  style="margin-top:10px;">
			<div class='card-header py-3 bg-info'>
              <h6 class="m-0 font-weight-bold" style="color:black;" >Bike List
	  ...
	  ini_set('display_errors', 0);
					$q_e = $conn->query("SELECT * FROM `bike` WHERE `bike_status`!='Deleted'") or die(mysqli_error());
	   ...
	   ?>
					<tr>
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['bike_brand'];?></td>
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['bike_name'];?></td>
						<td style="text-size:8px;text-transform:capitalize;"><?php 
						if($f_e['bike_category']!=null){
						echo $f_e['bike_category'];
						}else{
						echo "No Assign Yet";    
						}
						?></td>
						<td style="text-size:8px;text-transform:capitalize;"><?php  
						$total_points = $f_e['bike_wheels'] + $f_e['bike_seat'] + $f_e['bike_frame'] +  $f_e['bike_bars'] + $f_e['bike_set'];
						echo $total_points;
						?></td>
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['bike_status']?></td>	
						<td style="text-size:8px;text-transform:capitalize;">
						    
							<a href="monitoring-update.php?bike_id=<?php echo $f_e['bike_id']?>" class="btn-info btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
								<i class="fas fa fa-eye fa-m text-white-100" style="font-size:15px;" title="Mail"></i> Update Bike
							</a>
