...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">Pricing Information</h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
	  ...
	  <a href="category.php" class="btn-danger btn-sm btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;">
			<i class="nav-icon fas fa-arrow-left" style="size:20px; margin-top:5px; " ></i>  Back</a>
	  <br><br> <div class="row">
	   <?php
					$pricing_id = $_GET['pricing_id'];
					$q_e = $conn->query("SELECT * FROM `category` WHERE `category_id`='$pricing_id'") or die(mysqli_error());
					while($f_e=$q_e->fetch_array()){
	   ?>
          <div class="col-md-12">
            <div class="card">
              <div class="card-header">
                <h5 class="card-title" style="text-transform:uppercase; margin-left:6%;font-size:30px; font-weight:bold;color:gray;"><?php echo $f_e["category_name"];?> - <?php echo $f_e["category_list"];?>  </h5>
              </div>
              <!-- /.card-header -->
              ...
              <div class="card-body">
				...
				<div class = "form-group row" >
					...
					<label>Range</label>
						<input type="text" required class = "form-control" name="category_range" value="<?php echo $f_e["category_range"];?>">		
					</div>
					<div class="col-sm-4  mb-3 mb-sm-0">
					<label>Price</label>
						<input type="text"  required class = "form-control" name="category_value" value="<?php echo $f_e["category_value"];?>">	
						<input type="hidden"  required class = "form-control" name="category_id" value="<?php echo $f_e["category_id"];?>">	
					</div>
					<div class="col-sm-4  mb-3 mb-sm-0">
			  ...
			  <div class= "updatebtn">
				...
				<?php 
						...
						if(isset($_POST['upload1'])){
							$category_range  = $_POST['category_range'];
							$category_value  = $_POST['category_value'];
							$category_id     = $_POST['category_id'];
							$update1 = $conn->query("UPDATE `category` SET `category_range`='$category_range',`category_value`='$category_value' WHERE `category_id` = '$category_id'");	
								if ($update1) {
									echo '<script>
										function myFunction() {
										swal({
										title: "Success! ",
										text: "Your Pricing Successfully Update",
									    icon: "success",
										type: "success"
										}).then(function() {
										window.location = "category-update.php?pricing_id='.$category_id.'";
									  });}
								  </script>';	
