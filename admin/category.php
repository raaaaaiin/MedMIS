...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">Pricing List Information</h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
	  ...
	  <div class="printPageButton">  
			...
			<a href="bike.php" class="btn-danger btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;"> 
				<i class="fas fa fa-coin fa-m text-white-100" style="font-size:15px;" title="Mail"></i>Go to Bike List	</a> 
			<a href="category.php" class="btn-danger btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;"> 
			<i class="fas fa fa-coin fa-m text-white-100" style="font-size:15px;" title="Mail"></i>Pricing	</a> 
	   </div>
	   
					
            <div class="card shadow mb-4"  style="margin-top:10px;">
			<div class='card-header py-3 bg-info'>
              <h6 class="m-0 font-weight-bold" style="color:black;" >Pricing List
	  ...
	  ini_set('display_errors', 0);
					$q_e = $conn->query("SELECT * FROM `category`") or die(mysqli_error());
	   ...
	   ?>
					<tr>
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['category_name'];?></td>
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['category_range'];?></td>
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['category_value']?></td>
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['category_list']?></td>	
						<td style="text-size:8px;text-transform:capitalize;">
						    
							<a href="category-update.php?pricing_id=<?php echo $f_e['category_id']?>" class="btn-info btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
								<i class="fas fa fa-eye fa-m text-white-100" style="font-size:15px;" title="Mail"></i> Update Pricing
							</a>
					...
					$result=$conn->query("UPDATE `bike` SET `bike_status`='Deleted' WHERE `bike_id`='$del_cart'");
					if($result){
					echo '<script>
									function myFunction() {
										swal({
										title: "Success!",
										text: "Successfully Remove Bike",
									    icon: "success",
										type: "success"
										}).then(function() {
