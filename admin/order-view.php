    ...
    <div class="sidebar" >
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        ...
        <div class="info">
		  ...
		  <?php  
          $cart = $_GET['cart_order'];
          $q_e = $conn->query("SELECT * FROM `cart` WHERE `cart_ref`='$cart'") or die(mysqli_error());
          $res = $q_e->fetch_array();
          $u_id = $res['cart_pharmacy'];
							  $userid = $u_id;
    ...
    <div class="content-header">
       <div class="row mb-2">
		...
		<div class="container-fluid"> 
			...
			<a href="#" class="btn-secondary btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
