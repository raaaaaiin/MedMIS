    ...
    <div class="content-header">
	  ...
	  <div class="printPageButton">  
	   ...
	   <?php			
					...
					$q_e = $conn->query("SELECT * FROM `section_info` WHERE `section_id`='$sect_id'") or die(mysqli_error());
					while($f_e=$q_e->fetch_array()){
							$student_num = $f_e['section_list_name'];
							$q1 = $conn->query("SELECT * FROM `user_account` WHERE `u_id` = '$student_num'") or die(msqli_error());
							$f1 = $q1->fetch_array();
	   ?>
					<tr>
				 ...
				 <div class  = "modal-body">
                  ...
                  <div class="col-sm-12 mb-3 mb-sm-0">
						...
						<select class="form-control" required name="name">
							...
							<?php
							$q_e1 = $conn->query("SELECT * FROM `user_account` WHERE `position`='Student' and `status`='Approve'") or die(mysqli_error());
