...
<div class="wrapper">
	  ...
	  <div class="printPageButton">  
	   ...
	   ?>
					<tr>
						...
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['section_adviser'];?></td>	
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['section_strand'];?></td>		
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['section_grade'];?></td>		
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['section_batch'];?></td>		
						<td style="text-size:8px;text-transform:capitalize;">
								<a href="section-student.php?sect_id=<?php echo $f_e['section_id'];?>" class="btn-success btn-sm btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
								<i class="fas fa fa-eye fa-m text-white-100" style="font-size:15px;" title="Mail"></i> View Section 
								</a>
								<a href="section.php?del_id=<?php echo $f_e['section_id'];?>" class="btn-danger btn-sm btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
								<i class="fas fa fa-trash fa-m text-white-100" style="font-size:15px;" title="Mail"></i> Delete Section 
								</a>
						</td>		
					</tr>
						<?php
						...
						if(isset($_GET['del_id'])){
								$section_id=$_GET['del_id'];
								$result=$conn->query("DELETE FROM section WHERE section_id='$section_id'");
								if($result){
						date_default_timezone_set('Asia/Manila'); 
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
         ...
         <form method = "POST" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype = "multipart/form-data"autocomplete="off" >
			<div class="modal-body">
				...
				<div class = "form-group row" >
                    <div class="col-sm-6 mb-3 ">
						<label>Adviser</label>
						<input type="text" name="adv" class = "form-control" required  style="text-transform:capitalize;">
					</div>
                    <div class="col-sm-6 mb-3 ">
						<label>Batch  </label>
						<input type="text" name="bat" class = "form-control" required >
					</div>
				</div>
        ...
        <div class="modal-footer">
          ...
          <button  class = "btn btn-primary" name = "p_section" style="float:right;"><span class = "fas fa-save"></span> Save Section </button>
        </div>
							</form>
      </div>
    </div>
  ...
  if(isset($_POST['p_section'])){
	  ...
	  $adv 		= $_POST['adv'];
	  $bat		= $_POST['bat'];
	  $sql123 	="INSERT INTO section VALUES(null,'$name','$adv','$strand','$grade','$bat')";		
