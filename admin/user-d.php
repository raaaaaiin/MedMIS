  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
	  ...
	  <div class="printPageButton">  
			...
			<a href="user-d.php" class="btn-danger btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
			...
			<div class='card-header py-3 bg-info'>
              <h6 class="m-0 font-weight-bold" style="color:black;" >Driver List
            ...
            <div class="card-body" >
              <div class="table-responsive" > 
	             ...
	             <?php		
					...
					$q_e = $conn->query("SELECT * FROM `user_account` WHERE `position`='Driver'") or die(mysqli_error());
				...
				<tr>
					...
					<td style="text-size:8px;text-transform:uppercase;"><?php echo $f_e['user_id_number']?></td>
