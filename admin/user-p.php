  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
	  ...
	  <div class="printPageButton">  
			...
			<a href="user-p.php" class="btn-danger btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
            ...
            <div class="card-body" >
              <div class="table-responsive" > 
	            ...
	            ?>
				<tr>
					<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['lname']?></td>
