  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
	  ...
	  $update = $conn->query("UPDATE `question` SET `status` = '1' WHERE `question_id` = '$id'");	 
								$q1c = $conn->query("SELECT * FROM `question` WHERE `question_id`='$id'") or die(msqli_error());
								$f_e = $q1c->fetch_array();	
								$qid = $f_e['question_id'];
								$q1c1 = $conn->query("SELECT * FROM `question_answer` WHERE `answer_topic`='$qid'") or die(msqli_error());
								$f_e1 = $q1c1->fetch_array();	
								$user_id_ans = $f_e1["answer_user"];
								$q1c12 = $conn->query("SELECT * FROM `user_account` WHERE `u_id`='$user_id_ans'") or die(msqli_error());
