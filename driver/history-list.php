...
<html lang="en">
  ...
  <tbody>
		  ...
		  $store_id = $_GET['store_id'];
					$q_e = $conn->query("SELECT * FROM `cart` WHERE  `cart_ref`='$store_id'") or die(mysqli_error());
	...
	$status =$f_e['status'];
		...
		$f12 = $q12->fetch_array();
		$cart_order_driver = $f12['cart_order_uid'];
  ...
  <thead>
    <tr>
      ...
      <th scope="col" style="font-weight: normal;"><?php echo $total_price_all?> Php</th>
    </tr>
  </thead>
</table>
<br><br>
<b style="margin-top:30px;">Customer Details:</b>
<b></b>
<h6 style="margin-top:20px;">Customer Name: </h6>
<h6 style="margin-top:20px;"><?php echo $f11['fname']?></h6>
				</div>
            </div>
        </section>
        <!-- Footer-->
