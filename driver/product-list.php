		  ...
		  ?> 
				   <div class="col mb-5">
                        <div class="card h-100">
                            <!-- Product image-->
                            <img class="card-img-top" src="../student/img/<?php echo $f_e['product_img']?>" alt="..." />
                            <!-- Product details-->
							<form action="insert.php" method="GET">
                            <div class="card-body p-4">
                                <div class="text-center">
                                    <!-- Product name-->
                                    <h5 class="fw-bolder"><?php echo $f_e['product_name']?></h5>
                                    <!-- Product price-->
                                     <?php echo $f_e['product_price']?> Php  - 
                                     <?php echo $f_e['product_qty']?> Qty
									 <br>
									 <br><center>
									 <input type="text" class="form-control"name="qty" style="width:100px;" placeholder="0" required onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))">
                            ...
                            <div class="card-footer p-4 pt-0 border-top-0 bg-transparent">
                                <div class="text-center"><button class="btn btn-outline-dark mt-auto" name="prod_button">Add to Cart</button></div>
                            </div>
							</form>
                        </div>
                    </div> 
