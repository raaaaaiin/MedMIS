...
<html lang="en">
  ...
  <h1>About Us Page</h1>
  <h5 style="text-align:center">MediGrab</h5>
  <p>MediGrab aims to bring the medicine transaction to an online platorm, where customers can easily purchase medicine to the comforts of their homes, and have it delivered right at their door.</p>
</div>
...
<div class="row">
  <div class="column">
    <div class="card">
      <div class="container">
        <h2>Bianca Czyrel K. Fleras</h2>
        <p class="title">Lead Programmer</p>
        <p>biancafleras@gmail.com</p>
      </div>
    </div>
  </div>
  ...
  <div class="column">
    <div class="card">
      <div class="container">
        <h2>Christine Jean Latupan</h2>
        <p class="title">Web Deisgner</p>
        <p>Latupan@gmail.com</p>
      </div>
    </div>
  </div>
</div>
