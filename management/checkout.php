			  ...
			  ?>  
               ...
               <form method = "POST" action = "<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" enctype = "multipart/form-data"autocomplete="off" >
				...
				<div class="form-group">
                  <div class="col-sm-4 mb-3 mb-sm-0" style="margin-left:10px;">
					<label><b>Complete your Address Here</b></label>
                    <input type="text" class="form-control" style=" text-transform:capitalize;width:300px;"required = "required" name = "address" value="<?php echo $f['brgy']." ".$f['city']?>">
                  </div>
				  <div class="col-sm-4 mb-sm-0"  style="margin-left:10px;">
					<label><b>Your Contact Number</b></label>
                    <input type="text" class="form-control"	style="text-transform:capitalize;width:300px;" name = "number" required onkeypress="return (event.charCode !=8 && event.charCode ==0 || (event.charCode >= 48 && event.charCode <= 57))" maxlength="11" minlength="11" >
                  </div>
				  <div class="col-sm-4 mb-sm-0"  >
					<label><b> Receiving Option</b></label>
                    <select class="form-select" name="option" style="text-transform:capitalize;width:300px;">
				  ...
				  <div class="col-sm-4 mb-sm-0"  >
                    ...
                    <select class="form-select" name="option1" style="text-transform:capitalize;width:300px;">
                    ...
                    <section class="py-5"> 
                         <a class="btn btn-danger" href="#" data-bs-toggle="modal" data-bs-target="#gcash">For Gcash Payment</a> 
                    </section>
				  ...
				  <div class="col-sm-4 mb-sm-0"  style="margin-left:10px;">
                    ...
                    <input type="file" class="form-control"	style="text-transform:capitalize;width:300px;" name = "file1"  >
                  </div>
				  <div class="col-sm-4 mb-sm-0"  style="margin-left:10px;">
					<label><b>Discount ID (Senior/PWD)</b></label>
                    <input type="file" class="form-control"	style="text-transform:capitalize;width:300px;" name = "file"  >
                  </div>
                </div>
                </div>
      ...
      <th scope="col"><?php echo $total_price_all + 59?> Php</th>
               ...
               <div class="col-sm-5 mb-3 mb-sm-0">
				<div class="form-group">
				  ...
				  <p><small>Review your items before placing your order. Once you check out, you can no longer cancel</small></p>
