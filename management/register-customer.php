...
if(isset($_POST['register'])){
  ...
  $position = "Client";
    ...
    if(empty($username_err) && empty($email_err) && empty($password_err) && empty($confirm_password_err)){
        ...
        $sql = "INSERT INTO user_account (username,email,password,fname,mname,lname,brgy,city,position,user_id_number,status,ref) VALUES (?,?,?,'$fname','$mname','$lname','$brgy','$city','$position','','Approve','')";
