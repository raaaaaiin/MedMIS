...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">Queries Section</h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
	  ...
	  <div class="printPageButton">  
			...
			<a href="#" class="btn-danger btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" data-toggle="modal" data-target="#addProduct"> 
				<i class="fas fa fa-school fa-m text-white-100" style="font-size:15px;" title="Mail"></i> Add New Queries			
			</a>
            <div class="card shadow mb-4"  style="margin-top:10px;">
			<div class='card-header py-3 bg-info'>
              <h6 class="m-0 font-weight-bold" style="color:black;" >Queries List
	  ...
	  $q_e = $conn->query("SELECT * FROM `question` WHERE `question_stu_id`='$u_id'") or die(mysqli_error());
	  while($f_e=$q_e->fetch_array()){
														
	  ?>
					<tr>
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['question_topic'];?></td>			
						<td style="text-size:8px;text-transform:capitalize;"><?php echo $f_e['question_date']?></td>				
						<td style="text-size:8px;text-transform:capitalize;"><?php if ($f_e['status']==3 || $f_e['status']==2) { echo "Answered";}else{ echo "Not Yet Answering";}?></td>				
						<td style="text-size:8px;text-transform:capitalize;"><a href="view_question.php?question=<?php echo $f_e['question_id']?>" class="btn-danger btn-m btn"  style="text-transform:capitalize;color:white;text-stroke:2px solid black;" > 
							<i class="fas fa fa-eye fa-m text-white-100" style="font-size:15px;" title="Mail"></i> View Question
							</a>
						</td>			
    ...
    <div class="modal-dialog" role="document">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          ...
          <button  class = "btn btn-primary" name = "pyinsert" style="float:right;"><span class = "fas fa-save"></span> Ask A Question </button>
        </div>
							</form>
      </div>
    </div>
  ...
  if(isset($_POST['pyinsert'])){
	  ...
	  $sql123 ="INSERT INTO question VALUES(null,'$title','$u_id','$desc','$date','0')";		
