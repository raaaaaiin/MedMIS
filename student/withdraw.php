...
<div class="wrapper">
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
       <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark printPageButton">Withdrawal Information</h1>
          </div><!-- /.col -->
           <!-- /.col -->
        </div>
        </div>
  ...
  if(isset($_POST['pyinsert'])){
    ...
    move_uploaded_file($tmp, "img/" . $uRefNo.".".$extension[1]);
	  $sql123 ="INSERT INTO product VALUES(null,'$u_id','$name','$name1','$quantity','$price','$quantity','$u_id','$rtransdate')";		
					if (mysqli_query($conn, $sql123)) {
									echo '<script>
									function myFunction() {
										swal({
